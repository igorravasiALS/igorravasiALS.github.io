...
(function () {
  $(document).ready(function () {
    ...
    tableau.extensions.initializeAsync().then(function () {
		  ...
		  var worksheet = tableau.extensions.dashboardContent.dashboard.worksheets[6];
		  var worksheet1 = tableau.extensions.dashboardContent.dashboard.worksheets[7];
		  var worksheet2 = tableau.extensions.dashboardContent.dashboard.worksheets[8];
