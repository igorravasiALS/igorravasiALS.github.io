...
(function () {
  $(document).ready(function () {
    ...
    tableau.extensions.initializeAsync().then(function () {
		  ...
		  var worksheet = tableau.extensions.dashboardContent.dashboard.worksheets[2];
		  var worksheet1 = tableau.extensions.dashboardContent.dashboard.worksheets[3];
		  var worksheet2 = tableau.extensions.dashboardContent.dashboard.worksheets[4];
